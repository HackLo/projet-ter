<div id="wrapper">
  ...
  <img src="graphics/monde1.jpg" alt="Monde de Raynor Hell" width="220px" height="119px" class ="imagecontenu leftpic" />
  <img src="graphics/monde2.jpg" alt="Monde de Raynor Hell" width="220px" height="119px" class="imagecontenu rightpic" />
	<p>Notre planète est un amoncellement de cendres sans âme dans lequel le vivant n'a plus vraiment son mot à dire. Seule espèce capable d'affronter les conséquences d'une explosion volcanique dévastatrice, l'Homme a choisi de profondément modifier son métabolisme pour amoindrir les dangers et douleurs imposés par cet environnement, qui est désormais son principal prédateur. Contraint de se prémunir pour survivre, il se retrouve esclave des technologies transhumanistes dont il rêvait autrefois et le plaisir simple de la nourriture a disparu depuis bien longtemps de son mode de vie. Le minerais d'uranium est la principale source d'énergie de ce nouveau monde, et comme toute ressource naturelle, son exploitation est synonyme de son épuisement. Une pénurie potentielle des ressources constitue désormais l'ennemi commun, et l'armée s'est adaptée&#160;: c'est elle qui explore les terres environnantes à la recherche de nouveaux gisements. Raynor Hell est l'un des leaders à la tête des expéditions dans les terres inconnues.</p><br />

	<h2>Le dôme</h2>
  <img src="graphics/dome1.jpg" alt="Dôme" width="220px" height="97px" class ="imagecontenu leftpic" />
  <img src="graphics/dome2.jpg" alt="Dôme" width="220px" height="97px" class="imagecontenu rightpic" />
  ...
  <img src="graphics/dome3.jpg" alt="Dôme" width="220px" height="145px" class ="imagecontenu leftpic intext" />
  <img src="graphics/dome4.jpg" alt="Dôme" width="220px" height="145px" class="imagecontenu rightpic intext" />
  ...
  <div class="video-container">
  	<iframe src="//www.youtube.com/embed/fUQ9E-c_b4E?rel=0" frameborder="0" allowfullscreen></iframe>
  </div><br /><br />
